    ...
    return (
        ...
        <div style={{ overflowY: 'auto', marginTop: '15px', borderRadius: '4px',  }}>
            ...
            <Box display="flex" justifyContent="space-between" mb={1} borderBottom={1}>
                ...
                <Typography variant="subtitle1" style={{ fontWeight: 'bold', width: '25%' }}>
                    Name
                </Typography>
                <Typography variant="subtitle1" style={{ fontWeight: 'bold', width: '20%' }}>
                    Type
                ...
                <Typography variant="subtitle1" style={{ fontWeight: 'bold', width: '15%' }}>
                    Active?
                </Typography>
            </Box>
                    ...
                    {items.map((item, index) => (
                        <div key={index} onClick={() => onItemSelect(item)}>
                            <Box display="flex" justifyContent="space-between" mb={1}>
                                ...
                                <Box flex="0 1 25%" style={{ width: 'auto' }}>
                                    <Typography variant="subtitle1" align="left">{item.xlong || 'N/A'}</Typography>
                                </Box>
                                <Box flex="0 1 20%" style={{ width: 'auto' }}>
                                    <Typography variant="subtitle1" align="left">{item.xtypeobj || 'N/A'}</Typography>
                                </Box>
                                <Box flex="0 1 20%" style={{ width: 'auto' }}>
                                    <Typography variant="subtitle1" align="left">{item.xgtype || 'N/A'}</Typography>
                                </Box>
