...
const Pogrndirect = () => {
  ...
  const handleItemSelect = useCallback((item) => {
    ...
    setFormData((prev) => ({
      ...prev,
      xgrnnum: item.xgrnnum,
      xwh: item.xwh,
      xcus: item.xcus,
      xref: item.xref,
      xorg: item.xorg,
      xlong: item.xlong,
      xstatusdoc: item.xstatusdoc,
    }));
  }, []);
    ...
    if (window.confirm("Are You Sure to Confirm This GRN?")) {
      ...
      try {
        const response = await axiosInstance.post(
          "/api/pogrnheader/confirmRequest",
          params
        );
                  ...
                  >
                    ...
                    <Typography
                      ...
                      sx={{
                        ...
                        color:
                          formData.xstatusdoc === "Confirmed" ? "green" : "red", // Conditional styling
                      }}
                    >
                      {formData.xstatusdoc}
                    </Typography>
